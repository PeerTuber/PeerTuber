...
final tVideoModel = VideoModel(
  ...
  name: 'My Test Video',
  category: CategoryModel.fromEntity(tCategory),
  licence: LanguageModel.fromEntity(tLanguage),
  language: LanguageModel.fromEntity(tLanguage),
  privacy: CategoryModel.fromEntity(tCategory),
  nsfw: false,
  ...
  likes: 1,
  dislikes: 1,
  thumbnailPath: '/static/thumbnails/3d3cc270-af78-4ae8-9de2-5002d34a79e8.jpg',
  previewPath: '/lazy-static/previews/833974db-6b62-4754-959b-f3efbe96d666.jpg',
  ...
  isLive: false,
  account: AccountModel.fromEntity(tAccount),
  channel: ChannelModel.fromEntity(tChannel),
);
